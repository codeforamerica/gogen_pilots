...
type FakeCMSWriter struct {
	...
	WriteEntryStub        func(data.CMSEntry, processor.EligibilityInfo)
	writeEntryMutex       sync.RWMutex
	writeEntryArgsForCall []struct {
		arg1 data.CMSEntry
		arg2 processor.EligibilityInfo
	}
...
func (fake *FakeCMSWriter) WriteEntry(arg1 data.CMSEntry, arg2 processor.EligibilityInfo) {
...
func (fake *FakeCMSWriter) WriteEntryCalls(stub func(data.CMSEntry, processor.EligibilityInfo)) {
	fake.writeEntryMutex.Lock()
	defer fake.writeEntryMutex.Unlock()
	fake.WriteEntryStub = stub
}

func (fake *FakeCMSWriter) WriteEntryArgsForCall(i int) (data.CMSEntry, processor.EligibilityInfo) {
	fake.writeEntryMutex.RLock()
	defer fake.writeEntryMutex.RUnlock()
...
var _ processor.CMSWriter = new(FakeCMSWriter)
