...
var _ = Describe("gogen", func() {
	...
	FIt("runs and has output for Contra Costa", func() {
		...
		Expect(sessionString).To(ContainSubstring("Found 5 convictions total that are Maybe Eligible - Flag for Review"))
		...
		Expect(sessionString).To(ContainSubstring("Found 4 convictions with eligibility reason Has convictions in past 5 years"))
