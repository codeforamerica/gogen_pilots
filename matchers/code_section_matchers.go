...
var Prop64MatchersByCodeSection = map[string]*regexp.Regexp{
	"11357(a)":              regexp.MustCompile(`11357\(A\).*HS`),
	"11357(b)":              regexp.MustCompile(`11357\(B\).*HS`),
	"11357(c)":              regexp.MustCompile(`11357\(C\).*HS`),
	"11357(d)":              regexp.MustCompile(`11357\(D\).*HS`),
	"11357(no-sub-section)": regexp.MustCompile(`11357(\([^A-D]\)|[^(]).*HS`),
	"11358":                 regexp.MustCompile(`11358.*HS`),
	"11359":                 regexp.MustCompile(`11359.*HS`),
	"11360":                 regexp.MustCompile(`11360.*HS`),
}
