...
func (ef testEligibilityFlow) ProcessSubject(subject *Subject, comparisonTime time.Time, county string, age float64, yearsConvictionFree int) map[int]*EligibilityInfo {
